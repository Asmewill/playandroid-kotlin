...
import com.example.oapp.ui.fragment.ProjectItemFragment
import com.example.oapp.ui.fragment.WeChatItemFragment

/**
 * Created by jsxiaoshui on 2021/6/30
 */
class ProjectPageAdapter(private val listData:ArrayList<ProjectData>, fm:FragmentManager):FragmentStatePagerAdapter(fm) {
    private  val  fragmentList=ArrayList<Fragment>()
    init {
       listData.forEach {
           fragmentList.add(ProjectItemFragment.getInstance(it.id))
       }
    }
