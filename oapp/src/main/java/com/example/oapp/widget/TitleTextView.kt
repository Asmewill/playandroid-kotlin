...
class TitleTextView : View {
    ...
    fun setText(text: String): TitleTextView {
        mTiltText = text
        postInvalidate()
        return this
    }

    fun setText(resId: Int): TitleTextView {
    ...
    fun setTiltBgColor(color: Int): TitleTextView {
        mTiltBgColor = color
        mPaint!!.color = mTiltBgColor
        postInvalidate()
        return this
    ...
    fun setTextColor(color: Int): TitleTextView {
        mTextColor = color
        mTextPaint!!.color = mTextColor
        postInvalidate()
        return this
    ...
    fun setTextSize(size: Int): TitleTextView {
    ...
    fun setTiltLength(length: Int): TitleTextView {
